//Top-Players title color

const playerTitle = document.getElementById('top-player');
playerTitle.style.color = 'white'

// Top-Blogs title color
const blogTitle = document.getElementById('top-blog');
blogTitle.style.color = 'white';

//main section background color rgba
const blogs = document.getElementsByClassName('container');
        for (const container of blogs){
            container.style.backgroundColor = 'rgba(68, 93, 120, 0.5)';
